"""
Django settings for uivdcer_248 project.
...
WSGI_APPLICATION = "uivdcer_248.wsgi.application"
...
SPECTACULAR_SETTINGS = {
    ...
    "TITLE": "uivdcer_248 API",
    "DESCRIPTION": "API documentation for uivdcer_248 App",
    "VERSION": "v1",
}
